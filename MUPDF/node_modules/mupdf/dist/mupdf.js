...
function Free(ptr) {
    return libmupdf._wasm_free(ptr);
}
export const Matrix = {
...
export class Image extends Userdata {
    constructor(pixmap_or_buffer, mask) {
        let pointer = 0;
        if (typeof pixmap_or_buffer === "number")
            ...
            pointer = libmupdf._wasm_new_image_from_pixmap(pixmap_or_buffer.pointer, mask ? mask.pointer : 0);
        else
